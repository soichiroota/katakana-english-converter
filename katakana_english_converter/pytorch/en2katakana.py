...
pickle.dump(input_lang, open(os.path.join(cur_dir, 'pkl_objects',
   'input_lang.pkl'), 'wb'), protocol=4)
pickle.dump(output_lang, open(os.path.join(cur_dir, 'pkl_objects',
   'output_lang.pkl'), 'wb'), protocol=4)
...
pickle.dump(encoder1, open(os.path.join(cur_dir, 'pkl_objects',
   'encoder.pkl'), 'wb'), protocol=4)
pickle.dump(attn_decoder1, open(os.path.join(cur_dir, 'pkl_objects',
   'decoder.pkl'), 'wb'), protocol=4)